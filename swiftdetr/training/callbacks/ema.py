...
class SwiftDetrEMACallback(Callback):
    """Exponential Moving Average with optional tau-based warm-up.

    Drop-in replacement for ``swiftdetr.util.utils.ModelEma`` implemented as a
    ...
    def should_update(
        ...
        also triggers an update at epoch boundaries, matching Swift-DETR's
