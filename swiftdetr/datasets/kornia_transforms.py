...
"""Kornia-based GPU augmentation pipeline for Swift-DETR detection training.
...
Usage::
    ...
    from swiftdetr.datasets.kornia_transforms import (
...
def _has_cuda_device() -> bool:
    ...
    Uses the fork-safe global ``DEVICE`` constant from ``swiftdetr.config`` so that
...
def _require_kornia() -> None:
    ...
    try:
        ...
        raise ImportError("GPU augmentation requires kornia. Install with: pip install 'swiftdetr[kornia]'") from e
