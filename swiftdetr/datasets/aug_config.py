...
"""Augmentation presets and default configuration for Swift-DETR training.

Import a preset and pass it as ``aug_config`` to your training call:

```python
from swiftdetr.datasets.aug_config import AUG_CONSERVATIVE, AUG_AGGRESSIVE, AUG_AERIAL, AUG_INDUSTRIAL
