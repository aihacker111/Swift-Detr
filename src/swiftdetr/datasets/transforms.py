...
# Albumentations wrapper for Swift-DETR
...
class AlbumentationsWrapper:
    ...
    This wrapper integrates Albumentations transforms with Swift-DETR's data pipeline,
    ...
    def _apply_geometric_transform(
        ...
        back to Swift-DETR format. Handles box removal and per-instance field filtering.
    ...
    def __call__(
        ...
        This method handles the data format conversion between Swift-DETR and Albumentations:
