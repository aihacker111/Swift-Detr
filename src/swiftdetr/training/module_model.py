...
"""LightningModule for Swift-DETR training and validation."""
...
class SwiftDetrModule(LightningModule):
    """LightningModule wrapping the Swift-DETR model and training loop.
    ...
    def _use_fused_optimizer(self) -> bool:
        ...
        Examples:
            ...
            >>> module = SwiftDetrModule.__new__(SwiftDetrModule)
    ...
    def test_step(self, batch: Tuple, batch_idx: int) -> Dict[str, Any]:
        ...
        from :class:`~swiftdetr.training.callbacks.BestModelCallback` at end of training).
    ...
    def on_load_checkpoint(self, checkpoint: dict[str, Any]) -> None:
        ...
        2. **Converted format** — a file produced by
           :func:`~swiftdetr.training.checkpoint.convert_legacy_checkpoint` that
           ...
           :class:`~swiftdetr.training.callbacks.ema.SwiftDetrEMACallback`.
        ...
        # Stash legacy EMA weights for SwiftDetrEMACallback.setup(), which restores
        ...
        if "legacy_ema_state_dict" in checkpoint:
            ...
            warnings.warn(
                ...
                "Add SwiftDetrEMACallback to your trainer callbacks to restore them; "
