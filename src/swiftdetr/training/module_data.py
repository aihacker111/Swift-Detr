...
"""LightningDataModule for Swift-DETR dataset construction and loaders."""
...
class GradAccumAlignedDataset(torch.utils.data.Dataset):
    ...
    Padding indices are drawn randomly from the original dataset.  Because Swift-DETR
...
class SwiftDetrDataModule(LightningDataModule):
    """LightningDataModule wrapping Swift-DETR dataset construction and data loading.
