...
"""Shared logger factory for Swift-DETR modules."""
...
class _SwiftDetrLogger(logging.Logger):
...
def get_logger(name: str = "swift-detr", level: int | None = None) -> _SwiftDetrLogger:
    ...
    if not isinstance(logger, _SwiftDetrLogger):
        logger.__class__ = _SwiftDetrLogger
