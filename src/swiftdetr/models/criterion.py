...
"""Loss functions and criterion for Swift-DETR training."""

import torch
import torch.nn.functional as F  # noqa: N812
from torch import nn

from swiftdetr.models.heads.segmentation import (
    calculate_uncertainty,
    get_uncertain_point_coords_with_randomness,
    point_sample,
)
from swiftdetr.models.math import accuracy
from swiftdetr.util import box_ops
from swiftdetr.util.distributed import get_world_size, is_dist_avail_and_initialized
